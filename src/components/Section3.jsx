    ...
    <div className="w-full md:h-screen bg-white flex justify-center items-center md:relative md:top-0 absolute top-[750px]">
      <div className="flex md:w-[80%] md:h-[90%] justify-around flex-col w-full h-full">
        <div className="w-full h-auto flex justify-around items-center">
          <div className="md:h-[200px] flex justify-center items-center flex-col text-center flex-1">
            <img className=" h-[60px] w-[60px] relative -left-4  md:h-[80px] md:w-[80px]" src={HealthCheck} />
