      ...
      <div className="md:w-[700px] w-full mx-auto px-4">
        <div className="flex justify-between items-center w-full">
          ...
          <div className="hidden md:flex items-center justify-between w-full space-x-1">
            ...
            <a href="#section-four" onClick={() => scrollToSection('section-four')} className="py-4 px-2 text-black font-extrabold">Ixtisoslik</a>
            <a href="#services" onClick={() => scrollToSection('services')} className="py-4 px-2 text-black font-extrabold">Xizmatlar</a>
            <a href="#connect" onClick={() => scrollToSection('connect')} className="py-4 px-2 text-black font-extrabold">Aloqa</a>
          </div>
        </div>
      </div>
      {/* Mobile Menu */}
      <div className={`md:hidden fixed top-0 left-0 h-full z-40 w-64 bg-white shadow-xl transition-transform duration-300 ease-in-out transform ${mobileMenuOpen ? "translate-x-0" : "-translate-x-full"}`}>
